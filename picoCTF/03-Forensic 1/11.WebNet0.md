...
└─$ ls -la
total 28
drwxrwxr-x  2 kali kali  4096 Apr 25 15:58 .
drwxrwxr-x 14 kali kali  4096 Apr 25 15:56 ..
...
```
Edit->Find Next->
Y en los Packet details vamos a buscar una cadena(String) que va a ser: picoCTF
La encuentra, sale en el encapsulamiento de los paquetes
Copy-> as Printable Text->Se pega en un editor:
