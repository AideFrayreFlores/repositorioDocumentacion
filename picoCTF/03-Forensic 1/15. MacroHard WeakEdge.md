...
## Solucion
```
┌──(kali㉿kali)-[~/forest/MacroHard]
└─$ wget https://mercury.picoctf.net/static/52da699e0f203321c7c90ab56ea912d8/Forensics%20is%20fun.pptm        
--2025-04-30 13:17:15--  https://mercury.picoctf.net/static/52da699e0f203321c7c90ab56ea912d8/Forensics%20is%20fun.pptm
...
Forensics is fun.pptm                     100%[===================================================================================>]  97.75K  57.5KB/s    in 1.7s    

2025-04-30 13:17:43 (57.5 KB/s) - ‘Forensics is fun.pptm’ saved [100093/100093]
...
zsh: permission denied: ppt/slideMasters/hidden

┌──(kali㉿kali)-[~/forest/MacroHard]
└─$ ppt/slideMasters       

┌──(kali㉿kali)-[~/forest/MacroHard/ppt/slideMasters]
└─$ cd ppt/slideMasters/hidden
cd: no such file or directory: ppt/slideMasters/hidden

┌──(kali㉿kali)-[~/forest/MacroHard/ppt/slideMasters]
└─$ cat ppt/slideMasters/hidden
cat: ppt/slideMasters/hidden: No such file or directory
...
┌──(kali㉿kali)-[~/forest/MacroHard]
└─$ cat ppt/slideMasters/hidden | tr ' ' '' | base64 -d
